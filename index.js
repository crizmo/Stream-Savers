...
/*  
    Most of the commented code here is just commented for local use 
    Un comment it if u are directly hosting it on replit or any other platform 
    
    All the commented code is working and is valid 
*/
